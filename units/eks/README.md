...
- **[addons/cilium](addons/cilium/README.md)**: Cilium in CNI chaining mode alongside `vpc-cni`, for `NetworkPolicy` enforcement and Hubble flow visibility, installed on the MNG before Karpenter
...
- **[`hubble-ui-httproute`](https://github.com/ConsciousML/argocd-app-of-apps-template/tree/main/charts/gateway-api/httproute)** (app-of-apps): exposes the Hubble UI deployed by [addons/cilium](addons/cilium/README.md)
