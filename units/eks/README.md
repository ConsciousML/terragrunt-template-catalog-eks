...
- **[`network-policies-aws-endpoints`](https://github.com/ConsciousML/argocd-app-of-apps-template/tree/main/manifests/network-policies)** (app-of-apps): `CiliumNetworkPolicy` egress rules scoped to pinned VPC endpoint IPs from [`vpc_endpoints`](../vpc_endpoints/README.md) instead of `toEntities: world`
