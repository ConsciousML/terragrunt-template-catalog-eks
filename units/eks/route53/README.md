...
- **[`units/eks/addons/argocd/app_of_apps`](../addons/argocd/app_of_apps/)**: threads the ACM certificate ARN into app-of-apps's `helm-gateway-api` app, which uses it for the Gateway's `LoadBalancerConfiguration` HTTPS listener
