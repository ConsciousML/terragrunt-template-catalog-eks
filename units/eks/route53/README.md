...
- **[acm_certificate](acm_certificate/)**: Issues a wildcard certificate (`*.{domain}`) validated via DNS against the public hosted zone
...
- **[`units/eks/addons/tailscale/split_dns`](../addons/tailscale/split_dns/)**: reads the private hosted zone domain name to configure Tailscale DNS interception
