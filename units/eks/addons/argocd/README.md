...
- **[`helm-argocd-ingress`](https://github.com/ConsciousML/argocd-app-of-apps-template/tree/main/helm-argocd-ingress)** (app-of-apps): it's this chart that deploys the ArgoCD server `Ingress`
