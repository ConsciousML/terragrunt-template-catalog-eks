...
dependency "load_balancer_configuration_private" {
  config_path = "../../load_balancer_configuration/private"
  mock_outputs = {
    name = "private"
  }
  mock_outputs_allowed_terraform_commands = ["init", "plan", "validate", "graph", "destroy"]
    ...
    spec = {
      ...
      infrastructure = {
        parametersRef = {
          ...
          name  = dependency.load_balancer_configuration_private.outputs.name
        }
      }
      listeners = [
        {
