...
dependency "target_group_configuration_private" {
  config_path = "../../target_group_configuration/private"
  mock_outputs = {
  ...
  fields = {
    spec = {
      ...
      defaultTargetGroupConfiguration = {
        name = dependency.target_group_configuration_private.outputs.name
      }
