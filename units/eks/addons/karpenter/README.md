...
- **[`units/eks/addons/argocd/app_of_apps`](../argocd/app_of_apps/)**: takes an ordering dependency on `iam`
- **[`helm-karpenter`](https://github.com/ConsciousML/argocd-app-of-apps-template/tree/main/helm-karpenter)** (app-of-apps): it's this chart that deploys the controller
- **[`helm-karpenter-config`](https://github.com/ConsciousML/argocd-app-of-apps-template/tree/main/helm-karpenter-config)** (app-of-apps): it's this chart that deploys the `EC2NodeClass` and `NodePool`
