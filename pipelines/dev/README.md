...
- [`github.hcl`](../github.hcl): GitHub username and repository name for module sources
...
- [`provider_kubernetes.hcl`](provider_kubernetes.hcl): Kubernetes provider configuration sourced from the EKS cluster output
