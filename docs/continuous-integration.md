...
## Setup
### Initial Setup
Follow the [bootstrap guide](../bootstrap/enable_tg_github_actions/README.md) to configure GitHub Actions authentication with AWS.
...
Lastly, in the [bootstrap pipeline configuration](../bootstrap/enable_tg_github_actions/README.md#configuration) update the `policy_arns` so Terragrunt can run in GitHub Actions and deploy the bootstrap pipeline following the [deploy section](../bootstrap/enable_tg_github_actions/README.md#deploy).
